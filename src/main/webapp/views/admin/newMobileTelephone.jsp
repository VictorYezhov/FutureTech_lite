...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
    ...
    <form:form action="/newMobileTelephone?${_csrf.parameterName}=${_csrf.token}" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <label class="radio-inline">
                    <input name="3g" type="radio" id="radio1" value="${true}" required> yes
                </label>
                <label class="radio-inline">
                    <input  name="3g" type="radio"  id="radio2" value="${false}"> no
                </label>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <label class="radio-inline">
                    <input name="wifi" type="radio"  id="radio3" value="${true}" required> yes
                </label>
                <label class="radio-inline">
