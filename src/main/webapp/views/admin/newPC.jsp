...
<form:form action="/newPC?${_csrf.parameterName}=${_csrf.token}" method="post"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input name="videoAdapter" type="text" class="form-control" id="videoAdapter" required="required">
        </div>
    </div>
    <div class="form-group">
        <label for="processor" class="col-sm-2 control-label">Processor</label>
        <div class="col-sm-10">
            <input name="processor" type="text" class="form-control" id="processor" required="required">
        </div>
    </div>
    <div class="form-group">
        <label for="memory" class="col-sm-2 control-label">Memory Gb</label>
        <div class="col-sm-10">
            <input name="memory" type="number" class="form-control" id="memory" required="required">
        </div>
    </div>
    <div class="form-group">
        <label for="RAM" class="col-sm-2 control-label">RAM Gb</label>
        <div class="col-sm-10">
            <input  name="RAM" type="number" class="form-control" id="RAM" required="required">
        </div>
    </div>
    <div class="form-group">
        <label for="MotherLoad" class="col-sm-2 control-label">MotherLoad</label>
        <div class="col-sm-10">
            <input name="MotherLoad" type="text" class="form-control" id="MotherLoad" required="required">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input name="weight" type="number" class="form-control" id="weight" required="required">
        </div>
    </div>
    <div class="form-group">
