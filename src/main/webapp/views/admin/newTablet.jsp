...
<form:form action="/newTablet?${_csrf.parameterName}=${_csrf.token}" method="post"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input name="battery" type="number" class="form-control" id="battery" required="required">
        </div>
    </div>
    <div class="form-group">
        <label for="ammountofsim" class="col-sm-2 control-label">Amount of sim cards</label>
        <div class="col-sm-10">
            <input name="amounts" type="number" class="form-control" id="ammountofsim" required="required">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input name="camera" type="number" class="form-control" id="camera" required="required">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input name="Screendiagonal" type="number" class="form-control" id="Screendiagonal" required="required">
        </div>
    </div>
    <div class="form-group">
